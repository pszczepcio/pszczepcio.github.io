...
var taskContent = parentEl.find('[data-task-content-paragraph]').tex
...
var preparedListOptions = prepareBoardOrListSelectOptions(availableBoards);
...
var selectedListId = $relatedTaskRow.find('[data-list-name-select]')
if (!selectedListId) {
...
$tasksContainer.on('change','[data-board-name-select]', handleBoardNam
$tasksContainer.on('click','[data-trello-card-creation-trigger]', hand
$tasksContainer.on('click','[data-task-edit-button]', toggleEditingSta
$tasksContainer.on('click','[data-task-edit-abort-button]', toggleEdit
$tasksContainer.on('click','[data-task-submit-update-button]', handleT
$tasksContainer.on('click','[data-task-delete-button]', handleTaskDele
});